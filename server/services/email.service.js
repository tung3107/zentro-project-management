...
class EmailService {
  ...
  async sendResetUserPassword(email, password) {
  ...
  <td style="padding: 50px 40px;">
    <div style="text-align: center;">
      <div style="background: linear-gradient(135deg, rgba(203, 4, 4, 0.05) 0%, rgba(243, 113, 33, 0.05) 100%); border-radius: 15px; padding: 30px; margin-bottom: 30px; border: 2px solid rgba(203, 4, 4, 0.1);">
        <h2 style="color: #153060; font-size: 28px; font-weight: 600; margin: 0 0 15px 0;"Zentro</h2>
        <p style="color: #64748b; font-size: 16px; margin: 0 0 25px 0; line-height: 1.6;">
          Tài khoản của bạn đã được admin reset mật khẩu! Mật khẩu mới của bạn là:
        </p>

        <!-- Email -->
        <div style="background: #f1f5f9; color: #153060; font-size: 16px; font-weight: 500; padding: 15px 20px; border-radius: 10px; margin: 10px 0;">
      ...
      <div style="background: #f8fafc; border-radius: 12px; padding: 25px; margin: 30px 0; border-left: 4px solid #f37121;">
        ...
        <ul style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0; padding-left: 20px; text-align: left;">
          <li style="margin-bottom: 8px;">Vui lòng đổi mật khẩu sau khi đăng nhập để đảm bảo an toàn.</li>
          <li style="margin-bottom: 8px;">Không chia sẻ thông tin tài khoản với người khác.</li>
        </ul>
      </div>
    ...
    await this.sendEmail({
      email,
      subject: "[Zentro] Admin just reset your password",
      html,
    });
  }

  async sendUserInfor(email, password) {
    const html = `<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; font-family: 'Space Grotesk', sans-serif; background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); min-height: 100vh;">
  ...
  <td style="padding: 50px 40px;">
    <div style="text-align: center;">
      <div style="background: linear-gradient(135deg, rgba(203, 4, 4, 0.05) 0%, rgba(243, 113, 33, 0.05) 100%); border-radius: 15px; padding: 30px; margin-bottom: 30px; border: 2px solid rgba(203, 4, 4, 0.1);">
        <h2 style="color: #153060; font-size: 28px; font-weight: 600; margin: 0 0 15px 0;">Chào mừng bạn đến với Zentro!</h2>
        <p style="color: #64748b; font-size: 16px; margin: 0 0 25px 0; line-height: 1.6;">
          Tài khoản của bạn đã được tạo thành công. Vui lòng sử dụng thông tin bên dưới để đăng nhập vào hệ thống:
        </p>
    ...
    await this.sendEmail({
      email,
      subject: "[Zentro] New account just created",
      html,
    });
  }
